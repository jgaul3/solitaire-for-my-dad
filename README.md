...
As a reminder, you can host HTML, CSS and JavaScript files on GitHub as pages. For example, I have bare bones To Do app at https://github.com/jgaul3/simple-to-do with an `index.html` document.
...
This means that this app is now available at https://jgaul3.github.io/simple-to-do/. Every time I publish to the `main` branch, it triggers an action and the page is generated.
...
The first thing you need to do change is the `index.html` document. You need two things for this. Your GitHub username, for example in this case `jgaul3` and the name of the repository you host as a GitHub Page, in this case `solitaire-for-my-dad`.

The current `index.html` has these settings already, and you need to change them accordingly.

In the following example, each `jgaul3` needs to become yours and `solitaire-for-my-dad` the name of your repository. Make sure to not remove any `/`, as they are crucial for this to work.
...
<head>
  ...
  <link rel="canonical" href="https://jgaul3.github.io/solitaire-for-my-dad/" />
  <link rel="manifest" href="/solitaire-for-my-dad/manifest.webmanifest">
</head>
<body>
...
``` javascript
{
  ...
  "icons": [
      {
        "src": "/solitaire-for-my-dad/img/icon.png",
        "type": "image/png",
        "sizes": "700x700"
      }
  ]
